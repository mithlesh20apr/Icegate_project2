...
export class Step6Component implements OnInit, ControlValueAccessor, Validator {
  ...
  onSubmit() {
    // console.log(this.homeConsumptionFormStep6.valid);
    // console.log(this.homeConsumptionFormStep6.value);
    // console.log();
    if (this.homeConsumptionFormStep6.valid === true) {
      this.homeConsumptionFormStep6.value
      Swal.fire({
