...
export class Step2Component implements OnInit, ControlValueAccessor, Validator {
  ...
  //   return (
  //     (!this.inBondFormStep2.get(field).valid && this.inBondFormStep2.get(field).touched) ||
  //     (this.inBondFormStep2.get(field).untouched && this.formSumitAttempt)
  //   );
  // }
  ...
  onSubmit() {
    // console.log(this.inBondFormStep2.valid);
    // console.log(this.inBondFormStep2.value);
    // console.log();
    if (this.inBondFormStep2.valid === true) {
      this.inBondFormStep2.value
      Swal.fire({
