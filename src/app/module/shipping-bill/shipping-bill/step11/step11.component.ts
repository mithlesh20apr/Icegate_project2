...
export class Step11Component implements OnInit {
  ...
  ngOnInit(): void {
    this.shipingBillStepEleven = this._formBuilder.group({
      ...
      be_quantity_utilised:['', [Validators.required,Validators.maxLength(16), ValidatorsService.numberValidator]],
      be_item_description:['',[Validators.required,Validators.maxLength(120)]],
      be_quantity:['', [Validators.required,Validators.maxLength(16), ValidatorsService.numberValidator]],
      be_uqc:['',[Validators.required,Validators.maxLength(3)]],
      be_assessed_value:['', [Validators.required,Validators.maxLength(16), ValidatorsService.numberValidator]],
      be_duty_paid:['', [Validators.required,Validators.maxLength(16), ValidatorsService.numberValidator]],
      be_duty_payment_date:['',Validators.required],
      be_other_identifiable_parameter:['',[Validators.required,Validators.maxLength(250)]],
      be_assessed_value_claim:['', [Validators.required,Validators.maxLength(16), ValidatorsService.numberValidator]],
