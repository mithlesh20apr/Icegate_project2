...
export class ShippingBillComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.ShippingBill = this._fb.group({
      ...
      shipingBillSStepEleven: new FormControl(""),
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            this.ShippingBill.patchValue({
              ...
              shipingBillSStepEleven: {

                invoice_serial_no: data.shipingBillSStepEleven.invoice_serial_no,
                item_serial_no: data.shipingBillSStepEleven.item_serial_no,
                serial_no: data.shipingBillSStepEleven.serial_no,
                be_site: data.shipingBillSStepEleven.be_site,
                be_no: data.shipingBillSStepEleven.be_no,
                be_date: data.shipingBillSStepEleven.be_date,
                be_invoice_no: data.shipingBillSStepEleven.be_invoice_no,
                be_item: data.shipingBillSStepEleven.be_item,
                manual_be: data.shipingBillSStepEleven.manual_be,
                be_quantity_utilised: data.shipingBillSStepEleven.be_quantity_utilised,
                be_item_description: data.shipingBillSStepEleven.be_item_description,
                be_quantity: data.shipingBillSStepEleven.be_quantity,
                be_uqc: data.shipingBillSStepEleven.be_uqc,
                be_assessed_value: data.shipingBillSStepEleven.be_assessed_value,
                be_duty_paid: data.shipingBillSStepEleven.be_duty_paid,
                be_duty_payment_date: data.shipingBillSStepEleven.be_duty_payment_date,
                be_other_identifiable_parameter: data.shipingBillSStepEleven.be_other_identifiable_parameter,
                be_assessed_value_claim: data.shipingBillSStepEleven.be_assessed_value_claim,
                be_item_used: data.shipingBillSStepEleven.be_item_used,
                commisioner_permission: data.shipingBillSStepEleven.commisioner_permission,
                input_credit: data.shipingBillSStepEleven.input_credit,
                personal_used: data.shipingBillSStepEleven.personal_used,
                modvat_availed: data.shipingBillSStepEleven.modvat_availed,
                modvat_repaid: data.shipingBillSStepEleven.modvat_repaid,
