...
export class ValidatorsService {
    ...
    static getValidatorErrorMessage(validatorName: string, validatorValue?: any) {
        let config = {
            ...
            'maxNumber': 'Maxiume 12 number is allowed',
            ...
            'maxlength': `The maximum field length is ${validatorValue.requiredLength}, please update the field`,
        };
    ...
    static Decimalcheck(regx: RegExp, number: Number): ValidatorFn {
        ...
        return (control: AbstractControl): { [key: string]: boolean } | null => {
            if (isNaN(control.value)) {
                ...
                if (count > number) {
                    return { 'digitsBeforeDecimal_d': true };
                }
